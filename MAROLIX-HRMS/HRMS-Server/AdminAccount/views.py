    ...
    user_data = [
        {
            ...
            "ReportingManager":User.objects.get(reporting_manager=user['reporting_manager']).first_name+" "+User.objects.get(reporting_manager=user['reporting_manager']).last_name,
